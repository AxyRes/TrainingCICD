    ...
    <body>
        ...
        <nav class="navbar navbar-expand-lg">
            <div class="container">
                ...
                <a href="index.jsp" class="navbar-brand mx-auto mx-lg-0">First</a>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-7 col-12">
                            <div class="hero-text">
                                ...
                                <h2 class="mb-4">My name is Tien. Here is my stolen websites</h2>
                        ...
                        <div class="col-lg-6 col-12">
                            <div class="profile-thumb">
                                <div class="profile-title">
                                    <h4 class="mb-0">Information Tien</h4>
                                </div>
                                ...
                                <div class="profile-body">
                                    ...
                                    <p>
                                        <span class="profile-small-title">Phone</span> 
                                         <span><a href="tel: 305-240-9671">0869-936-918</a></span>
                                    </p>
                            ...
                            <div class="about-thumb">
                                <div class="row">
                                    <div class="col-lg-6 col-6 featured-border-bottom py-2">
                                        <strong class="featured-numbers">22+</strong>

                                        <p class="featured-text">Years of Experiences</p>
                                    </div>

                                    <div class="col-lg-6 col-6 featured-border-start featured-border-bottom ps-5 py-2">
                                        <strong class="featured-numbers">1000+</strong>

                                        <p class="featured-text">Happy Customers</p>
                                    </div>

                                    <div class="col-lg-6 col-6 pt-4">
                                        <strong class="featured-numbers">888</strong>
                ...
                <div class="container">
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-2 col-4 ms-auto clients-item-height">
                            <img src="images/clients/FPT-University.png" class="clients-image img-fluid" alt="">
                        </div>

                        <div class="col-lg-2 col-4 clients-item-height">
                            <img src="images/clients/wisky-code9.jpg" class="clients-image img-fluid" alt="">
                        </div>

                        <div class="col-lg-2 col-4 clients-item-height">
                            <img src="images/clients/Passio-Coffee.jpg" class="clients-image img-fluid" alt="">
                        </div>

                        <div class="col-lg-2 col-4 clients-item-height">
                            <img src="images/clients/DXC-Technology.png" class="clients-image img-fluid" alt="">
                        </div>

                        <div class="col-lg-2 col-4 me-auto clients-item-height">
                            <img src="images/clients/hacker.png" class="clients-image img-fluid" alt="">
                        </div>
                            ...
                            <div class="row pt-lg-5">
                                    ...
                                    <div class="services-thumb">
                                        <div class="d-flex flex-wrap align-items-center border-bottom mb-4 pb-3">
                                            ...
                                            <div class="services-price-wrap ms-auto">
                                                <p class="services-price-text mb-0">$5,500</p>
                                                <div class="services-price-overlay"></div>
                                            </div>
                                        </div>

                                        <p>You may want to deploy source code to product enviroment.</p>
                                ...
                                <div class="col-lg-6 col-12">
                                    <div class="services-thumb services-thumb-up">
                                        <div class="d-flex flex-wrap align-items-center border-bottom mb-4 pb-3">
                                            <h3 class="mb-0">CI-CD</h3>

                                            <div class="services-price-wrap ms-auto">
                                                <p class="services-price-text mb-0">$2,500</p>
                                                <div class="services-price-overlay"></div>
                                            </div>
                                        </div>

                                        <p>You want automation for deploy code to server.</p>
                                ...
                                <div class="col-lg-6 col-12">
                                    <div class="services-thumb">
                                        <div class="d-flex flex-wrap align-items-center border-bottom mb-4 pb-3">
                                            ...
                                            <div class="services-price-wrap ms-auto">
                                                <p class="services-price-text mb-0">$2,600</p>
                                                <div class="services-price-overlay"></div>
                                            </div>
                                        </div>

                                        <p>If you need a maintain server for work stability.</p>
                                ...
                                <div class="col-lg-6 col-12">
                                    <div class="services-thumb services-thumb-up">
                                        <div class="d-flex flex-wrap align-items-center border-bottom mb-4 pb-3">
                                            ...
                                            <div class="services-price-wrap ms-auto">
                                                <p class="services-price-text mb-0">$5,450</p>
                                                <div class="services-price-overlay"></div>
                                            </div>
                                        </div>

                                        <p>This is protect for your project and server out of hackerlỏd</p>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-6 col-12">
                            <div class="projects-thumb">
                                <div class="projects-info">
                                    <small class="projects-tag">Continuous Integration</small>

                                    <h3 class="projects-title">Jenkins - Azure DevOps</h3>
                                </div>

                                <a href="images/projects/ci-devops.jpg" class="popup-image">
                                    <img src="images/projects/ci-devops.jpg" class="projects-image img-fluid" alt="">
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4 col-md-6 col-12">
                            <div class="projects-thumb">
                                <div class="projects-info">
                                    <small class="projects-tag">Monitoring - Maintain</small>

                                    <h3 class="projects-title">Grafana - Promethues</h3>
                                </div>

                                <a href="images/projects/mornitor.png" class="popup-image">
                                    <img src="images/projects/mornitor.png" class="projects-image img-fluid" alt="">
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4 col-md-6 col-12">
                            <div class="projects-thumb">
                                <div class="projects-info">
                                    <small class="projects-tag">Cyber Security</small>

                                    <h3 class="projects-title">Firewall - Proxy Server</h3>
                                </div>

                                <a href="images/projects/security.jpg" class="popup-image">
                                    <img src="images/projects/security.jpg" class="projects-image img-fluid" alt="">
                                </a>
                            </div>
                        </div>
                            ...
                            <div class="col-lg-3 col-md-6 col-12 pe-lg-0">
                                <div class="contact-info contact-info-border-start d-flex flex-column">
                                    ...
                                    <ul class="footer-menu">
                                        ...
                                        <li class="footer-menu-item"><a href="#" class="footer-menu-link">CICD</a></li>

                                        <li class="footer-menu-item"><a href="#" class="footer-menu-link">Maintain Server</a></li>

                                        <li class="footer-menu-item"><a href="#" class="footer-menu-link">Security</a></li>
                                    </ul>
                                    ...
                                    <p class="mb-0">This is my stolen websites. Im not a web developer. Im DevOps</p>
                                </div>
                            </div>
                                        ...
                                        <div class="col-lg-3 col-md-6 col-6">
                                            <div class="form-check form-check-inline">
                                                ...
                                                <label class="form-check-label" for="inlineCheckbox1">
                                                    ...
                                                    <span class="form-check-label-text">DevOps</span>
                                                </label>
                                          </div>
                                        </div>
                                        ...
                                        <div class="col-lg-3 col-md-6 col-6">
                                            <div class="form-check form-check-inline">
                                                ...
                                                <label class="form-check-label" for="inlineCheckbox2">
                                                    ...
                                                    <span class="form-check-label-text">CI-CD</span>
                                                </label>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-3 col-md-6 col-6">
                                            <div class="form-check form-check-inline">
                                                ...
                                                <label class="form-check-label" for="inlineCheckbox3">
                                                    ...
                                                    <span class="form-check-label-text">Monitoring</span>
                                                </label>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-3 col-md-6 col-6">
                                            <div class="form-check form-check-inline me-0">
                                                ...
                                                <label class="form-check-label" for="inlineCheckbox4">
                                                    ...
                                                    <span class="form-check-label-text">Security</span>
                                                </label>
                                            </div>
                                        </div>
